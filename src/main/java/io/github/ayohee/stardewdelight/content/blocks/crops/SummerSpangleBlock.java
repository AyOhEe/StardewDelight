...
public class SummerSpangleBlock extends FlowerCrop {
    private static final IntegerProperty AGE = BlockStateProperties.AGE_4;


    public SummerSpangleBlock(Properties properties) {
        super(properties);
    ...
    public BlockState getMatureBlockState() {
        return SDBlocks.GROWN_SUMMER_SPANGLE.getBlock().get().defaultBlockState();
    }
